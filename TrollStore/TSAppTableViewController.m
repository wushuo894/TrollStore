...
- (void)_setUpNavigationBar
{
	...
	UIAction* installFromURLAction = [UIAction actionWithTitle:@"通过 URL 安装" image:[UIImage systemImageNamed:@"link.badge.plus"] identifier:@"InstallFromURL" handler:^(__kindof UIAction *action)
	{
		dispatch_async(dispatch_get_main_queue(), ^
		{
			UIAlertController* installURLController = [UIAlertController alertControllerWithTitle:@"通过 URL 安装" message:@"" preferredStyle:UIAlertControllerStyleAlert];
